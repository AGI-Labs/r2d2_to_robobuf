...
def main(in_dir, out_dir, cam_idx):
    ...
    for fname in sorted(fnames):
        fps = 15  # Specify the desired frames per second
        ...
        for i, traj_start in enumerate(traj_starts):
            ...
            writer = imageio.get_writer(f"{out_dir}/{i:04d}_{out_name}", fps=fps)
...
if __name__ == "__main__":
    ...
    parser.add_argument("--cam_idx", help="Camera index to save videos from", default=0)
